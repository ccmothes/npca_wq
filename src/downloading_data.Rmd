...
Make NPCA regional boundaries layer:
```{r}
npca_regions <- 
  tibble::tibble(state = c("AK",
                                         "DE", "DC", "MD", "PA", "VA", "WV",
...
# to ever load it in to your environment. Doing the same for other layers for consistency:

attains_catchments <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                                  layer = "attains_au_catchments")
saveRDS(attains_catchments, 'data/mid/attains_au_catchments.RDS')

attains_areas <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                             layer = "attains_au_areas")
saveRDS(attains_areas, 'data/mid/attains_au_areas.RDS')

attains_lines <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                             layer = "attains_au_lines")
saveRDS(attains_lines, 'data/mid/attains_au_lines.RDS')

attains_points <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                              layer = "attains_au_points")
saveRDS(attains_points, 'data/mid/attains_au_points.RDS')

attains_assmnt_parms <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                                    layer = "attains_au_assmnt_parms")
saveRDS(attains_assmnt_parms, 'data/mid/attains_au_assmnt_parms.RDS')

attains_attributes <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
                                    layer = "attains_au_attributes")
saveRDS(attains_attributes, 'data/mid/attains_au_attributes.RDS')

attains_meta <- sf::st_read(dsn = list.files("data/in/ATTAINS", full.names = TRUE)[1],
...
hucs_test <- as_tibble(sort(c("0104","0106","0107","0108","0202","0415","1501","1407","1502","1505","1503","1506","0317","0315","0603","1102","1402",
                              "1401","1403","1405","1406","1404","1301","1408","1019","1018","0204","0314","0310","0308","0307","0309","0306","0313","2001",
                              "2002","2006","2005","2201","0602","0512","0404","0514","0708","0706","1107","0604","1026","1029","1027","0513","0511","0510",
                              "1103","0402","0405","0406","0806","0801","0410","0318","0316","0505","0305","0304","0601","0302","0303","0301","1011","1013",
                              "1006","1017","1015","1606","1809","1602","0203","1024","1302","1504","1108","1305","1306","1104","0412","0414","0110","0411",
                              "0506","0504","0508","0509","0207","0502","0208","1908","1101","0804","1111","1807","1805","1801","1804","1806","1802","1803",
                              "1704","1706","0713","0714","0809","0808","0803","0805","1114","0109","0206","0102","0103","0105","0904","1002","1701","1008",
                              "1007","1003","1113","1710","1707","1708","1709","2101","1012","1016","1109","1014","1202","1203","1209","1206","1304","1307",
                              "1308","1210","1211","2102","1603","1702","1711","0703","0704","0403","0401","0311","0312")))
...
Download the NHDPlus V2 database (for the app)
```{r}
nhdplus_contus_catchments <- sf::st_read(dsn = "data/in/NHDPlusV21_National_Seamless_Flattened_Lower48.gdb",
                                         layer = "Catchment")

# to pull faster, project and convert the catchment feature:
