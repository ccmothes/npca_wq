...
# These are the parks whose NHD HR has been altered since NPS's last HIS workflow. Their raw flowlines shapefile features embedded in the mdb were
# manually transformed to shapefiles in ArcGIS Desktop.
